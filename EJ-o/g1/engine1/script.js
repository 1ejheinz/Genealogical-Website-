...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container1").wowSlider({effect:"",prev:"",next:"",duration:10*100,delay:52*100,width:1200,height:200,autoPlay:true,autoPlayVideo:false,playPause:true,stopOnHover:true,loop:true,bullets:0,caption:false,captionEffect:"parallax",controls:false,controlsThumb:false,responsive:1,fullScreen:false,gestures:2,onBeforeStep:0,images:0});